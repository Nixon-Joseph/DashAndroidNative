...
class PopupWindow : AppCompatActivity() {
    private lateinit var popupTitle: String
    private lateinit var popupText: String
    private lateinit var popupButtonText: String
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        popupButtonText = bundle?.getString("popupbuttontext", "Button") ?: ""
        darkStatusBar = bundle?.getBoolean("darkstatusbar", false) ?: false

        popup_window_title.text = popupTitle
        popup_window_text.text = popupText
        popup_window_button.text = popupButtonText
